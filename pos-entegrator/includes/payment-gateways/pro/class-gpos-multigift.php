<?php
/**
 * MultiGift hediye kartının tüm özelliklerini uygulamaya tanıtır.
 *
 * @package Gurmehub
 */

/**
 * GPOS_MultiGift sınıfı.
 */
class GPOS_MultiGift extends GPOS_Gateway {
	 ...
	 * @var string $logo
	 */
	public $logo = GPOS_ASSETS_DIR_URL . '/images/logo/multigift.png';
